...
export const Icons = {
  logo: (props: LucideProps) => (
      <svg {...props} viewBox='0 0 1024 512' width="1024" height="512">
      <g>
        <path
        ...
        <path
          ...
          fill="#558ce7" opacity="1"></path>
        <ellipse cx="512" cy="244.04" rx="196.34" ry="186.42"
        ...
        <circle cx="149.39" cy="259.56" r="15.519"
          fill="#558ce7" opacity="1"></circle>
        <circle cx="362.61" cy="259.56" r="15.519"
          fill="#558ce7" opacity="1"></circle>
        
        {/* Text "Braveupstudios" */}
        <text x="650" y="300" fontSize="80" fontWeight="bold" fill="#222222" stroke="#ffffff" strokeWidth="2" textAnchor="start">
          Braveupstudios
        </text>
      </g>
    </svg>
