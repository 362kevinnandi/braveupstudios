...
export const Icons = {
  logo: (props: LucideProps) => (
        <svg {...props} viewBox="0 0 2200 1200" width="2200" height="1200">
      <g>
        {/* House outline */}
        ...
        {/* Text "Braveups" */}
        <text x="1500" y="800" fontSize="200" fontWeight="bold" fill="#222222" stroke="#ffffff" strokeWidth="5" textAnchor="start">
          Braveups
        </text>
      </g>
    </svg>
