...
export const Icons = {
  logo: (props: LucideProps) => (
       <svg {...props} viewBox="0 0 1800 1024" width="2200" height="1200">
      <g>
        {/* House outline */}
        ...
        {/* Text "Braveups" */}
        <text x="1400" y="650" fontSize="480" fontWeight="bold" fill="#222222" stroke="#ffffff" strokeWidth="3" textAnchor="start">
          Braveups
        </text>
      </g>
    </svg>
